...
namespace RoomBookingApp.Core
{
    public class RoomBookingRequestProcessorTest
    {
        ...
        [InlineData(BookingResultFlag.Failuare, false)]
        public void Should_Return_SuccessOrFailuare_Flag_In_Result(BookingResultFlag bookingSuccessFlag, bool isAvailable)
        {
            if (!isAvailable)
            {
                _availableRooms.Clear();
